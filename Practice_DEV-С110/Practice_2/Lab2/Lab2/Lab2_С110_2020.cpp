...
///////////////////////////////////////////////////////////////////
	{
		...
		int nAr[] = { 4, 45, 22, 3, 9, 10, 55 };	//массив для сортировки
		...
		double nAr2[] = { 4.4, 45.2, 22.1, 3.3, 3.1, 4.2, 5.9 };	//массив для сортировки
		...
		//Вызов сортировки
		int nTotal2 = sizeof(nAr2) / sizeof(nAr2[0]);		//количество элементов в массиве
...
///////////////////////////////////////////////////////////////////////////
	...
	//Задание 8.  
	{
		...
		const char str2[] = "Прямой путь";
		std::cout << "\n\nПрямой путь" << std::endl;
		reversStr2(str2);
		stop
	}
