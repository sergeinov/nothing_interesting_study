...
//TBook2 book1;							// инициализация нулями  
...
//в заголовочный файл.
	{
		...
		// локальная структура
		TBook2 book3;							// инициализация мусором
		printf("\n%d", sizeof(book3));		// 176 байт

		// статическая локальная структура
		static TBook2 book2;					// инициализация нулями
		printf("\n%d", sizeof(book2));		// 176 байт

		// создание одиночной динамической структуры
		TBook2* book4 = new TBook2;				// инициализация мусором
		printf("\n%d", sizeof*(book4));		// 176 байт

		// одномерный встроенный массив структур
		const int N = 5;
		TBook2 book5[N] = { 0 };				// обнуляем все поля массив структур // проинициализировать поля можно только при создании экземпляра
		...
		printf("\n\nЗадание 1.3\n");
		TBook2 book6;
		strcpy(book6.autor, "Сергей Семонович Труш");
		strcpy(book6.title, "Трясина");
		book6.year = 2011;
		book6.price = 55, 45;
		book6.category = Фантастика;
		printBOOK2(&book6);
