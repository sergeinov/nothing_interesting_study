...
///////////////////////////////////////////////////////////////
	{
		...
		char arr4[2][3] = {					// двумерный массив строковых литералов // мы можем читать и писать в массив
							{1,1,1},
							{2,2,2}
		};

		const char* arr5[] = { "Hello", "World" };  // массив указателей на char		// нельзя написать в память массива указателей
